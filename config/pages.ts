...
import SettingsPage from '~/components/Page/Settings/Spheres.vue'
import SettingsCPage from '~/components/Page/Settings/CostCentres.vue'
...
export const PAGES: Record<string, AppPage> = {
  ...
  SettingsC: { label: 'SettingsC', component: SettingsCPage, icon: '', roles: ['admin'] },
}